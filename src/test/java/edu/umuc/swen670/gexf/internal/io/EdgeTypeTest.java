...
public class EdgeTypeTest extends TestBase {
	...
	@Test
	public void ParseEdgeTypeSimpleFile() throws Exception {
		InputStream stream = this.getClass().getClassLoader().getResourceAsStream("testData/gexf/edgetypesimple.gexf");
		assertNotNull(stream);
	...
	@Test
	public void ParseGraphMutualFile() throws Exception {
		InputStream stream = this.getClass().getClassLoader().getResourceAsStream("testData/gexf/graphmutual.gexf");
		assertNotNull(stream);
	...
	@Test
	public void ParseGraphUndirectedFile() throws Exception {
		InputStream stream = this.getClass().getClassLoader().getResourceAsStream("testData/gexf/graphundirected.gexf");
		assertNotNull(stream);
