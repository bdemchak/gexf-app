...
public class NodeWithParentsOrderedTest extends TestBase {

	@Test
	public void ParseNodesWithParentsOrderedFile() throws Exception {
		InputStream stream = this.getClass().getClassLoader().getResourceAsStream("testData/gexf/nodeswithparentsordered.gexf");
...
//		ValidateEdgeAttributes(cyNetwork, nodeNameId.get("NodeOne"), nodeNameId.get("NodeTwo"), names, types, new Object[] {"directed"});
	...
	@Test
	public void ParseNodesNonExistentParentFile() throws Exception {
		InputStream stream = this.getClass().getClassLoader().getResourceAsStream("testData/gexf/nodesnonexistentparent.gexf");
		assertNotNull(stream);
